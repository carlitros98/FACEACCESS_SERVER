...
Para ello se han seguido dos arquitecturas, la primera para la comunicación entre servicio y aplicación del cliente ([FaceAccess Client](https://github.com/carlosparra1998/FACEACCESS_CLIENT)), y la comunicación entre servicio y aplicación del empleado ([FaceAccess Employee](https://github.com/carlosparra1998/FACEACCESS_EMPLOYEE)). 
